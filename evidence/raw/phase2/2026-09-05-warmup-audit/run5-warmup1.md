...
Pass: Cold: 0.022905ms GPU, 0.104988ms CPU, 0.02s total GPU, 0.27s total wall, 1000x 
Run:  [2/2] base [Device=0 T{ct}=I32 OffsetT{ct}=I32 Elements{io}=2^24]
Pass: Cold: 0.373493ms GPU, 0.442480ms CPU, 0.37s total GPU, 0.55s total wall, 1000x 
```
...
|-------|-------------|-----------------|-------------|---------|------------|--------|------------|--------|---------|--------------|--------|
|   I32 |         I32 |    2^16 = 65536 | 256.000 KiB |   1000x | 104.988 us | 42.08% |  22.905 us | 95.66% |  2.861G |  11.445 GB/s |  4.47% |
|   I32 |         I32 | 2^24 = 16777216 |  64.000 MiB |   1000x | 442.480 us |  8.50% | 373.493 us |  3.91% | 44.920G | 179.679 GB/s | 70.18% |
